...
public class TestTask2 {
	...
	public void testEmptyTable() {
		SChHastable tableEmpty = new SChHastable(3);
	...
	public void testAddOneElement() {
		// TODO
		SChHastable table = new SChHastable();
	...
	public void testRehash() {
		// TODO
		SChHastable table = new SChHastable(3);
		assertEquals(table.size(), 0);
		assertTrue(table.isEmpty());
		...
		//adding 4 first elements
		for (int i = 0; i < 4; i++)
		{
			table.add(gf[i]);
		}
		assertTrue(table.size() > 3);
		for (int i = 4; i < gf.length; i++)
		{
			table.add(gf[i]);
		}
